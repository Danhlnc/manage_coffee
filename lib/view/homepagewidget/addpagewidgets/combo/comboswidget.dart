                ...
                onPressed: () async {
                   await showDialog(
                      ...
                      builder: (BuildContext context) {
                        ...
                        return ComboListDialog(customer:  widget.customer,callBackFunc: callBack, );
                      }).then((value) {
                        setState(() {
                    ...
                    itemBuilder: (BuildContext ctx, int index) {
                      ...
                      return Row(
                        children: [
                          Expanded(
                            flex: 2,
                            child: Text("${widget.customer.listCombo[index].name} : ${widget.customer.listCombo[index].price}")),
                          Expanded(
                            flex: 1,
                            child: IconButton(onPressed: (
                              
                            ){
                              widget.customer.listCombo.remove(widget.customer.listCombo[index]);
                              widget.customer.tongTien =
                        widget.customer.soLuongSac8k! * 10000 +
                            widget.customer.soLuongSac12k! * 15000 +
                            widget.customer.soLuongMuonSac! * 3000 +
